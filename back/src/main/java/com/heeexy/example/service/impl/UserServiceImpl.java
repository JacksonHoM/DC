...
import com.heeexy.example.dao.DcUserDao;
...
public class UserServiceImpl implements UserService {
	...
	public JSONObject findAll(JSONObject jsonObject) {
		...
		CommonUtil.fillPageParam(jsonObject);
		int count = dcUserDao.countUser(jsonObject);
		List<JSONObject> list = dcUserDao.findAll(jsonObject);
		return CommonUtil.successPage(jsonObject,list,count);
	}
	...
	@Override
	public JSONObject addAddr(JSONObject jsonObject) {
		JSONObject js=(JSONObject) SecurityUtils.getSubject().getSession().getAttribute(Constants.SESSION_USER_INFO);
		jsonObject.put("userId",js.get("userId"));
		dcUserDao.addAddr(jsonObject);
		return CommonUtil.successJson();
	}
	...
	@Override
	public JSONObject updateUser2(JSONObject jsonObject) {
		dcUserDao.updateUser(jsonObject);
		return CommonUtil.successJson();
	}
